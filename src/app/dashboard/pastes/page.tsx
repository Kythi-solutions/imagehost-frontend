        ...
        <Content>
          <div className="flex flex-col gap-1">
            ...
            <div className="card max-w-xl min-h-96 !p-0 relative mt-3 flex flex-col">
              <div className="p-4 bg-background-secondary border-b-2 w-full">
