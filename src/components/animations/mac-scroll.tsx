...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[150vh]  flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.40] sm:scale-50"
    >
      {/* Lid */}
      <Lid
        src={src}
    ...
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      ...
      <Row>
        <KBtn className="" childrenClassName="h-full justify-between py-[4px]">
          ...
          <div className="flex justify-start w-full pl-1">b</div>
        </KBtn>
        <KBtn className="" childrenClassName="h-full justify-between py-[4px]">
          <div className="flex justify-end w-full pr-1">v</div>
        ...
        >
          <div className="flex justify-end w-full pr-1">b</div>
          <div className="flex justify-start w-full pl-1">
        ...
        <div className="w-[4.9rem] mt-[2px] h-6 p-[0.5px] rounded-[4px] flex flex-col justify-end items-center">
          <KBtn className="w-6 h-3">b</KBtn>
          <div className="flex">
            <KBtn className="w-6 h-3">b</KBtn>
            <KBtn className="w-6 h-3">v</KBtn>
            <KBtn className="w-6 h-3">b</KBtn>
          </div>
        </div>
      </Row>
