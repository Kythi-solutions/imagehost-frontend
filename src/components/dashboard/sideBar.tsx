...
const Sidebar: React.FC<{
  ...
  return (
    <div className="flex-col hidden w-72 rounded-sm  backdrop-blur-sm dark:bg-background-primary xl:flex border-1.5 overflow-hidden">
      ...
      <div className="mt-auto w-full flex justify-center border-t-2 border-background-secondary relative sidebarGlow">
        <div className="w-full h-24 z-20 p-3 bg-background-primary sidebarGlow">
