  ...
  return (
    ...
    >
      <label htmlFor={`input-checkbox-${id}`}>
        <div
          className={`w-full py-3 card md:py-4 px-3 base relative overflow-hidden anim md:px-5 rounded-lg border-2 flex items-center gap-4 cursor-pointer ${
            checked && "!border-purple-400/40"
          }`}
        >
          <div className="relative w-5 h-5">
            ...
            />
            <span className="block w-full h-full rounded relative border after:hidden anim peer-checked:bg-purple-400/30 peer-checked:after:block"></span>
          </div>
