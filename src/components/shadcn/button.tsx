  ...
  "inline-flex items-center duration-300 active:translate-y-1 anim justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-white/10 bg-background-light shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",
        ghost: "hover:bg-background-lighter hover:text-accent-foreground",
        opaque:
          "border border-white/10 bg-black/50 shadow-sm hover:bg-black/80 hover:text-accent-foreground",
